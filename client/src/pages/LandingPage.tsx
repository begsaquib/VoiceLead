  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-black selection:text-white overflow-x-hidden font-['Plus_Jakarta_Sans']">
      ...
      <nav className="flex items-center justify-between px-12 lg:px-24 py-12 max-w-screen-2xl mx-auto sticky top-0 bg-white/80 backdrop-blur-xl z-[100] border-b border-slate-50">
        ...
        <div className="hidden lg:flex items-center gap-16 text-[11px] font-black uppercase tracking-[0.3em] text-slate-700">
          <button
            onClick={() => scrollToSection("features")}
            className="hover:text-black transition-all hover:translate-y-[-1px]"
          >
            Features
          </button>
          <button
      ...
      <section className="px-12 lg:px-24 pt-32 pb-48 max-w-screen-2xl mx-auto text-center relative">
        <div className="space-y-16 relative z-10">
          <div className="inline-flex items-center gap-3 px-8 py-3 rounded-full border border-slate-100 text-[11px] font-black uppercase tracking-[0.4em] text-slate-600 bg-white/80 backdrop-blur-md shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
            <Sparkles size={16} className="text-indigo-600" /> AI-Powered Lead
            Capture
          </div>
          ...
          <p className="text-2xl lg:text-5xl text-slate-600 max-w-5xl mx-auto font-medium leading-[1.15] tracking-tight mt-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            Tired of typing contact details?{" "}
            <span className="text-black font-bold">Speak, snap, or scan</span> —
            our AI extracts lead info in seconds and syncs to your dashboard.
          </p>
      ...
      <section
        id="features"
        className="bg-slate-950 py-12 border-y border-white/5 overflow-hidden"
      >
        <div className="flex items-center gap-32 whitespace-nowrap animate-marquee">
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-6 opacity-40 hover:opacity-100 transition-all group"
            >
              <item.icon size={28} className="text-indigo-500" />
              <span className="text-4xl font-black tracking-tighter uppercase text-white group-hover:text-indigo-400">
                {item.text}
              </span>
            </div>
          ))}
      ...
      <section
        id="how-it-works"
        className="bg-slate-950 text-white px-12 lg:px-24 py-64 relative"
      >
        ...
        <div className="max-w-screen-2xl mx-auto space-y-32">
          <div className="flex flex-col lg:flex-row justify-between items-end gap-12">
            <div className="space-y-8 max-w-4xl">
              <span className="text-sm font-black text-indigo-400 uppercase tracking-[0.5em] block">
                Three Simple Steps
              </span>
            ...
            <p className="text-2xl text-white font-medium max-w-md leading-relaxed pb-6">
              From voice notes to organized leads in seconds. Capture contacts
              your way.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative">
            ...
            <div className="lg:col-span-4 bg-[#0a0c10] border border-white/5 rounded-[64px] p-16 flex flex-col justify-between hover:border-indigo-500/50 transition-all duration-700 group relative overflow-hidden h-[600px]">
              <div className="absolute top-0 right-0 p-12 text-white/5 font-black text-[120px] pointer-events-none group-hover:text-indigo-500/10 transition-colors">
                01
              </div>
              <div className="space-y-12 relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-white font-medium leading-relaxed">
                    <span className="text-white font-bold">Speak</span> your
                    notes, <span className="text-white font-bold">snap</span> a
                    business card, or{" "}
                    <span className="text-white font-bold">scan</span> a QR
                    code. Use whatever method works best in the moment.
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-8 bg-[#0a0c10] border border-white/5 rounded-[64px] p-16 hover:border-indigo-500/50 transition-all duration-700 group relative overflow-hidden flex flex-col justify-between h-[600px]">
              ...
              <div className="flex justify-between items-start relative z-10">
                ...
                <div className="text-white/5 font-black text-[120px] pointer-events-none">
                  02
                </div>
              </div>
              <div className="space-y-8 relative z-10">
                <h3 className="text-white text-7xl font-black tracking-tighter">
                  Extract.
                </h3>
                <p className="text-3xl text-white font-medium leading-tight max-w-3xl">
                  Our AI instantly structures the data — names, companies,
                  emails, phone numbers, and your custom notes. No manual typing
                  required.
                </p>
            ...
            <div className="lg:col-span-12 bg-white text-black rounded-[72px] p-20 flex flex-col lg:flex-row items-center justify-between gap-16 group hover:shadow-[0_80px_160px_-40px_rgba(0,0,0,0.5)] transition-all duration-1000">
              <div className="space-y-12 flex-1">
                ...
                <div className="space-y-6">
                  <h3 className="text-[80px] font-black tracking-tighter leading-none">
                    Sync.
                  </h3>
                  <p className="text-3xl text-slate-600 font-medium leading-relaxed max-w-3xl">
                    Review, edit if needed, and save directly to your dashboard.
                    All your leads organized, searchable, and ready for
                    follow-up.
                  </p>
                </div>
              </div>
      ...
      <section
        id="built-for"
        className="bg-[#05070a] text-white px-12 lg:px-24 py-80 relative overflow-hidden"
      >
        ...
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-24 relative z-10">
          <div className="lg:col-span-7 space-y-24">
            <div className="space-y-8">
              ...
              <h2 className="text-[100px] md:text-[180px] font-black tracking-tighter leading-[0.75] text-white">
                Built
                <br />
                For.
              </h2>
              <p className="text-3xl text-slate-300 font-medium leading-relaxed max-w-2xl">
                Whether you're at a busy trade show booth or networking at a
                conference, VoiceLead adapts to your workflow.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              {[
                {
                  title: "Trade Show Teams",
                  desc: "Capture hundreds of leads without expensive badge scanners. Just speak or snap.",
                  icon: Users,
                },
                {
                  title: "Sales & Biz Dev",
                  desc: "Never lose a contact again. Voice notes capture context that cards can't.",
                  icon: BarChart3,
                },
                {
                  title: "Enterprise Teams",
                  desc: "Seamless dashboard integration with analytics and export features.",
                  icon: Building2,
                },
                {
                  title: "Startups",
                  desc: "Cost-effective alternative to $800+ scanner rentals. Works on any phone.",
                  icon: Rocket,
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="group p-8 bg-white/5 border border-white/10 rounded-[40px] hover:bg-white/10 hover:border-indigo-500/50 transition-all duration-500"
                >
                  ...
                  <h4 className="text-white text-2xl font-black tracking-tight mb-2">
                    {item.title}
                  </h4>
              ...
              <div className="bg-[#0a0c10] border-2 border-indigo-500/30 rounded-[80px] p-16 aspect-square flex flex-col justify-between backdrop-blur-3xl relative z-10 shadow-[0_0_100px_rgba(79,70,229,0.1)]">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex flex-col items-end">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-200 mb-1">
                      Processing
                    </span>
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row justify-between items-center gap-24">
                      <div className="w-full md:w-auto flex items-center gap-8 justify-center md:justify-start opacity-80 group-hover:opacity-100 transition-opacity">
