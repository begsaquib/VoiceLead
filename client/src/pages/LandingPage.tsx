        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="mt-6 text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Stop typing business cards manually. Just speak, and our AI
              instantly extracts lead details and syncs them to your dashboard.
            </p>

            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/app"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all bg-blue-600 rounded-2xl shadow-lg shadow-blue-600/30 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/40 hover:-translate-y-1"
              >
                Start Capturing Free <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <a
                href="#demo"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-slate-700 transition-all bg-white border border-slate-200 rounded-2xl hover:bg-slate-50 hover:border-slate-300"
              >
                View Demo
              </a>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-slate-200/60">
            ...
            <div className="flex justify-center items-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              ...
              <span className="text-xl font-serif italic font-bold text-slate-800">
                GlobalTech
              </span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-slate-600 mb-6">
                Badge scanners are clunky, expensive, and don't capture context.
                VoiceLead turns your phone into an intelligent capture device
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600">
              Three simple steps to better lead management
            </p>
          </div>
            ...
            {[
              {
                icon: Mic,
                title: "1. Speak",
                desc: "After talking to a prospect, simply dictate their info and your notes.",
              },
              {
                icon: Sparkles,
                title: "2. AI Extracts",
                desc: "Our engine instantly structures the unstructured voice data.",
              },
              {
                icon: Database,
                title: "3. Save & Sync",
                desc: "Review the details and save directly to your dashboard.",
              },
            ].map((step, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-20 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-slate-300 mb-10">
            Join thousands of modern sales teams capturing more leads with less
            friction.
          </p>
          <Link
            href="/app"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-blue-600 bg-white rounded-2xl shadow-lg hover:bg-blue-50 transition-all transform hover:-translate-y-1"
          >
