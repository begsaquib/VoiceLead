...
import { Mic, LayoutDashboard, Download, User, Building2, Mail, Phone, Calendar, Search, Loader2 } from "lucide-react";
...
export default function AppPage() {
  ...
  const exportLeads = () => {
    ...
    const rows = leads.map(l => 
      `"${l.name}","${l.company}","${l.email}","${l.phone || ''}","${l.interest || ''}","${new Date(l.createdAt!).toLocaleDateString()}"`
    ).join("\n");
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-20">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold font-display text-lg">WeCommit Booth</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          {activeTab === "capture" ? (
            ...
            >
              {!isCapturing ? (
                <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-12 text-center">
                  ...
                  <h2 className="text-2xl font-bold font-display text-slate-900 mb-2">Ready to Capture</h2>
                  <p className="text-slate-500 mb-8 max-w-sm mx-auto">
                    Tap the microphone to start recording your conversation or dictate lead details.
                  </p>
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold font-display text-slate-900">Your Leads</h2>
                    ...
                    >
                      ...
                      {lead.interest && (
                        <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                          <p className="text-xs font-medium text-slate-500 mb-1 uppercase tracking-wide">Interest</p>
